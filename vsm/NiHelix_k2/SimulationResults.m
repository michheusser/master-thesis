...
%% High Field
model_High = mphload('Helix_VSM_k2_Nickel_High.mph')
%mphnavigator
...
%% LowField
model_Low = mphload('Helix_VSM_k2_Nickel_Low.mph')
%%
mu_0 = 1.25663706e-6;
mu_r = 1;
mu = mu_r*mu_0;
    
    [H_x, H_y, H_z, M_x, M_y, M_z, B_app, chi_m] = mphmean(model_Low,{'mfnc.Hx', 'mfnc.Hy', 'mfnc.Hz', 'mfnc.Mx', 'mfnc.My', 'mfnc.Mz', 'B_app','chi_m'},'volume','selection',2,'dataset','dset1');
    ...
    N_simulation_Low_2 = H_app*M^(-1) - eye(3)/chi_m(1);
