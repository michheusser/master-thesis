...
% Finding of rad1_rad2/rad2_rad1
load('N_simulation_Low45')
load('N_simulation_Low55')
load('N_simulation_Low65')
chi_a_sim_Low_45 = inv(N_simulation_Low45);
chi_a_sim_Low_55 = inv(N_simulation_Low55);
chi_a_sim_Low_65 = inv(N_simulation_Low65);


x_45 = fminsearch(@(x) eigdiff(x,chi_a_Low_ax_ax,chi_a_Low_ax_rad,chi_a_Low_rad_ax,chi_a_Low_rad_rad,chi_a_sim_Low_55),[0 0],optimset('PlotFcns',@optimplotfval))
[eig_diff_45, eig_measured_45] = eigdiff(x_45,chi_a_Low_ax_ax,chi_a_Low_ax_rad,chi_a_Low_rad_ax,chi_a_Low_rad_rad,chi_a_sim_Low_45)
x_55 = fminsearch(@(x) eigdiff(x,chi_a_Low_ax_ax,chi_a_Low_ax_rad,chi_a_Low_rad_ax,chi_a_Low_rad_rad,chi_a_sim_Low_55),[0 0],optimset('PlotFcns',@optimplotfval))
[eig_diff_55, eig_measured_55] = eigdiff(x_55,chi_a_Low_ax_ax,chi_a_Low_ax_rad,chi_a_Low_rad_ax,chi_a_Low_rad_rad,chi_a_sim_Low_55)
x = fminsearch(@(x) eigdiff(x,chi_a_Low_ax_ax,chi_a_Low_ax_rad,chi_a_Low_rad_ax,chi_a_Low_rad_rad,chi_a_sim_Low),[0 0],optimset('PlotFcns',@optimplotfval))
[eig_diff, eig_measured] = eigdiff(x,chi_a_Low_ax_ax,chi_a_Low_ax_rad,chi_a_Low_rad_ax,chi_a_Low_rad_rad,chi_a_sim_Low)
x_65 = fminsearch(@(x) eigdiff(x,chi_a_Low_ax_ax,chi_a_Low_ax_rad,chi_a_Low_rad_ax,chi_a_Low_rad_rad,chi_a_sim_Low_65),[0 0],optimset('PlotFcns',@optimplotfval))
[eig_diff_65, eig_measured_65]= eigdiff(x_65,chi_a_Low_ax_ax,chi_a_Low_ax_rad,chi_a_Low_rad_ax,chi_a_Low_rad_rad,chi_a_sim_Low_65)
%%
chi_a_Low = [...
...
plot(H_app_ax_pos*mu_0,M_rad_rad_pos,'b-*',... % Magnetization rad,rad
    H_app_ax_pos*mu_0,M_rad_ax_pos,'r-*',... % Magnetization rad,ax
    H_app_ax_pos*mu_0,H_app_ax_pos*chi_a_Low(1,1),'b--',... %Linearization (Low) rad,rad 
    H_app_ax_pos*mu_0,H_app_ax_pos*chi_a_Low(3,1),'r--',...%Linearization (Low) rad,ax
    H_app_ax_pos*mu_0,H_app_ax_pos*chi_a_sim_Low(1,1),'b-.',... %Simulation (Low) rad,rad 
    H_app_ax_pos*mu_0,H_app_ax_pos*chi_a_sim_Low(3,1),...%Simulation (Low) rad,ax
    H_app_ax_pos*mu_0,H_app_ax_pos*chi_a_sim_High(1,1),... %Simulation (High) rad,rad 
    H_app_ax_pos*mu_0,H_app_ax_pos*chi_a_an_High(3,1),'k--',... %Analytical (High) rad,ax
